...
SECRET_KEY = os.environ.get('SECRET_KEY', 'nxdcce1q(5r1ud1#tpyks6j1hvhq_a3qmc3&p$$!6w%(t!x7*8')
...
# AWS S3 / S3-Compatible Cloud Storage (e.g. Supabase Storage)
AWS_ACCESS_KEY_ID = os.environ.get('AWS_ACCESS_KEY_ID')
AWS_SECRET_ACCESS_KEY = os.environ.get('AWS_SECRET_ACCESS_KEY')
AWS_STORAGE_BUCKET_NAME = os.environ.get('AWS_STORAGE_BUCKET_NAME')
AWS_S3_ENDPOINT_URL = os.environ.get('AWS_S3_ENDPOINT_URL')  # e.g., https://[ref].supabase.co/storage/v1/s3
